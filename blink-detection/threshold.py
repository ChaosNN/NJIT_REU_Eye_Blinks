...
def compare_IOUs(EARs, file_path, file):
    ...
    save.save_csv(EARs,
             ga_t, pred_ga, pbp_gat,
             tcf_t, pred_tcf, pbp_tcft,
             h15_t, pred_h15, pbp_h15t,
             h2_t, pred_h2, pbp_h2t,
             h25_t, pred_h25, pbp_h25t,
             h3_t, pred_h3, pbp_h3t,
             h35_t, pred_h35, pbp_h35t,
             file_path, file)
